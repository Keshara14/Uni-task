...
from Modules.search import search_tasks
...
def dashboard():
    try:
        ...
        due_in_one_hour_js = [
            {
                ...
                'minutes_remaining': task.get('minutes_remaining'),
                'hours_remaining': task.get('hours_remaining'),
                'deadline': task['deadline'].isoformat() if isinstance(task.get('deadline'), datetime) else task.get('deadline')
            }
            for task in due_in_one_hour
        ]
        ...
        return render_template('dashboard.html',
                               ...
                               due_in_one_hour_js=due_in_one_hour_js,
